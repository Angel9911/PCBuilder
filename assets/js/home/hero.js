        ...
        <div class="max-w-2xl text-white">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <a href="${b.link}" class="${b.variant === 'primary'
                ...
                : 'border-2 border-white/60 bg-white/10 hover:bg-white/20 text-white backdrop-blur-md px-8 py-6 text-base rounded-xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl'
            }">${b.text}</a>`
        ).join('')}
          </div>
        </div>
